...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name && $email && $pass) {
        try {
            ...
            $_SESSION['flash'] = "✅ ลงทะเบียนนักเรียนสำเร็จ! เข้าสู่ระบบได้เลย";
...
<body>
    <div class="wrap">
        <div class="hero">
            <h2><i class="bi bi-person-plus-fill"></i> ลงทะเบียน (นักเรียน)</h2>
            <p>สำหรับผู้สอนที่ต้องการจัดการรายวิชาและนักเรียน</p>
        </div>
        ...
        <div class="card">
            ...
            <form method="POST" autocomplete="off">
                ...
                <div class="group">
                    ...
                    <input name="name" placeholder="เช่น นางสาวสมใจ ใจดี" required>
                </div>
                ...
                <button class="btn" type="submit"><i class="bi bi-check2-circle"></i> ลงทะเบียน</button>
            </form>
